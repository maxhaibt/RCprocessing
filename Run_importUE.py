...
config = RClib.loadconfigs('C:/Users/tronc/Documents/GitHub/RCprocessing/config_sedimentcores.json')
...
for index, mesh in meshdf.iterrows():
    ...
    tasks = UE5lib.build_import_tasks(mesh['OBJ File'], mesh['Texture Files'], "/Game/WES_paleoenvi/cores/", options)
